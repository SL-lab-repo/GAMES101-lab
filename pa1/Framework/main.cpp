...
Eigen::Matrix4f get_rotation(Vector3f axis, float angle){
    ...
    auto rotate_3d = cos(angle*MY_PI/180) * Eigen::Matrix3f::Identity() +
                        (1- cos(angle*MY_PI/180))*axis*axis.transpose() +
                        sin(angle*MY_PI/180) * m3;
                                      ...
                                      float zNear, float zFar)
{
    ...
    auto t = tan(eye_fov/2*MY_PI/180) * zNear;
    auto b = -t;
